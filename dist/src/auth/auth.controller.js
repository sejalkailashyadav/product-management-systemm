...
let AuthController = class AuthController {
    ...
    user(req) {
        console.log(...oo_oo(`9f830475_0`, req.user));
        if (req.user) {
    ...
    async logout(userId, req, res) {
        console.log(...oo_oo(`9f830475_1`, req.cookies));
        res.clearCookie("jwt_payload");
        res.redirect("/auth/signin");
        res.clearCookie("refresh_token", { path: "/" });
        console.log(...oo_oo(`9f830475_2`, req.cookies));
        return true;
    }
    app(req, res) {
