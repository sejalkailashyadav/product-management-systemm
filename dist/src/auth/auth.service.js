...
let AuthService = class AuthService {
    ...
    async signinLocal(dto, req, res) {
        ...
        console.log(...oo_oo(`790f193_0`, products, categories));
        if (user.isadmin) {
    ...
    async getTokens(userId, email) {
        ...
        console.log(...oo_oo(`790f193_1`, jwtPayload));
