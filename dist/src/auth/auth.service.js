...
let AuthService = class AuthService {
    ...
    async signinLocal(dto, req, res) {
        ...
        console.log(...oo_oo(`4ffce488_0`, users));
        return tokens;
    }
