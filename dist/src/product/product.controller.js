...
let ProductController = class ProductController {
    ...
    async insertUser(dto, res, req, file) {
        ...
        console.log(...oo_oo(`d4cddaca_0`, "fileeeeeeeeeeee"));
        console.log(...oo_oo(`d4cddaca_1`, file));
